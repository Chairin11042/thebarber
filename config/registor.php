...
<script src="/thebarber/node_modules/sweetalert2/dist/sweetalert2.all.min.js"></script>
    <!-- Optional: include a polyfill for ES6 Promises for IE11 -->
    <script src="https://cdn.jsdelivr.net/npm/promise-polyfill"></script>
    <script src="/thebarber/node_modules/sweetalert2/dist/sweetalert2.min.js"></script>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="custaddr" placeholder="เบอร์โทร">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
